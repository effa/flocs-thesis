...
we simply take average of the phase skills, which means
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.6\textwidth]{img/robomission-student-model}
\caption{%
  Student model used in RoboMission includes a skill for each phase
  (computed from the previous skill and the new observed performance),
