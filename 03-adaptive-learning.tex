...
REF: comprehensive overview: \cite{its-learner-models}
...
- outer and inner loop (figure?)
  (outer loop: "problem selection loop",
  choosing chunk, choosing a task within a chunk, inner loop: helping a student
  to solve the task, giving hints, providing feedback).
