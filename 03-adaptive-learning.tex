...
\item oven without concepts, the models can have
  rich structure (e.g. prerequisities between tasks,
    see right figure \ref{fig:chunks-prerequisities})
...
\item and / or / both (example in figure \ref{fig:chunks-prerequisities})
...
\item TODO: diagram (heatmap of similarities between tasks / concepts)
