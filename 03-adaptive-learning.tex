...
\item However: evaluation of the usage application might be difficult (ex./REF),
  -> proxies, such as predictive accuracy.
  (with the hope that it would lead to the improvement in the application).
%\item Although better predictions usually help,
%  the relationship between their quality and the long term objectives (REF)
...
\item TODO: Effort vs. Score plot/metrics \cite{learner-models-integration-skills}
...
\item Online evaluation is more reliable, but also much more costly.
