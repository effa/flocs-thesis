...
The most explored area is skill modeling; broader student models may also
...
while others only describe the state of the student between tasks %sessions
...
Models that contain learning include additional assumptions
about how the learning happens. % CITE:examples
...
Another family of student models is based on \emph{Bayesian networks} (CITE),
where nodes correspond to either hidden or observed skills and performances,
...
Therefore, it is safer to observe several proxy quality measures,
...
Nevertheless, simulation is perfect for model debugging,
...
and which can be safely set manually (CITE). % without frequent retraining.
