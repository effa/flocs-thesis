...
and \emph{Network Elo} that utilize task similarities in the network domain model.
\cite{rihak-phd}.
(TODO: what about overlapping concepts, which we are most interested about)
