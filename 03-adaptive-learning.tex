...
Evaluation layer allows for \emph{iterative improvement} of ALS.
...
was observed to hold not only for ALS \cite[p.124]{its-domain-models, stupid-tutoring-systems-intelligent-humans}, % TODO: better resource?
but also for recommender systems in general \cite[][Rule 16]{google-ml-rules}.
...
and should be learned, and which can be safely set manually (CITE). % without frequent retraining.
...
by combining collected performance data % TODO:check
