...
where nodes correspond to either skills and performances,
...
In \emph{dynamic Bayesian networks} (DBN) (CITE) nodes also depend
...
adaptive behavior of the system, or by the self-selection bias (CITE). % TODO:CITE
