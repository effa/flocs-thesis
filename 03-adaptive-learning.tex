...
Student model captures the state of the student (e.g., skills) estimated from the
...
was observed to hold for adaptive learning systems \cite[p.124]{its-domain-models, stupid-tutoring-systems-intelligent-humans}, % TODO: better resource?
