...
\imgW[0.8]{concepts-tasks-relationships}{%
...
while only a single from all \emph{disjunctive prerequisities} is enough.
Conjuctive and disjunctive prerequisites can be represented together by
...
\centering
\includegraphics[height=45mm]{img/prerequisites-poks}
\caption{DAG of prerequisites}
\label{fig:concepts-hierarchical-tree}
\end{subfigure}%
\begin{subfigure}[t]{0.55\textwidth}
\centering
\includegraphics[height=45mm]{img/prerequisites-and-or}
