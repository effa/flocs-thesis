...
\smallskip
Typical adaptive learning system consists of the following components
...
so adaptive learning systems often focus only on the outer loop decisions \cite{als-future}.
