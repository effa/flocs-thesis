...
\item Domain model is a collection of educational content, covered concepts
  and relationships between them. (TODO: improve the definition, REF to examples)
\item Usage:
\begin{enumerate}
...
\subsection{Chunks}  % consider: "Chunks and Relationships", "General Chunk Model"
...
\item concepts are flat clusters of taks
...
\begin{itemize}
\item generalization relationship between concepts
\item TODO: diagram
...
\item and / or / both
\item TODO: diagram
\item REF usage: KSI (existing systems)
\end{itemize}
