...
Next section attempt to extrapolate useful strategies for teaching programming.
...
However, it adds a new feature: colors on the grid,
  which can be used for conditioning.
...
input, output, move-from, move-to, add, and jump.
