...
TODO: Backend provides REST API (CITE) by defining database models, serializers and
viewsets  (+ core)
The technologies are becoming obsolete soon, so will not discuss them in detail.
An overview of technologies which are used currently in the project
