...
% "This mechanism ..."
It also allows to switch between RoboCode and RoboBlocks
anytime when writing a solution in the game editor.
...
\imgW[0.6]{robocode-transformations}{Transformations between RoboAST and four possible code presentations -- RoboBlocks, RoboCode, MiniRoboCode, and RoboJS.}
...
The specific implementation we used (CITE) allows to define how should each
...
\begin{lstlisting}
CompoundStatement = IfStm / WhileStm / RepeatStm

WhileStm = "while" __ t:Test ":" b:Body
...
The main advantage is that it does not require any lexer % TODO: check term
and the resulting grammar is still readable and short;
...
which is a JavaScipt that can be fed into a JS interpreter.
...
and then use JS-interpeter (CITE) to run the code.
