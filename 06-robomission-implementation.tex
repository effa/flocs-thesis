...
The PEG for RoboCode % (as described in section \ref{sec:syntax-semantic})
...
The interpreter would not have to be necessary a JavaScript interpreter,
since it is easy to transform RoboAST to any common imperative language.
% (at least to the common imperative languages).
However, the interpreter must satisfy the following conditions:
