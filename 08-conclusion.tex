...
% TODO: Conisder a stronger conclusion with mentioning again the main outcome
% of the project (RoboMission + initial analysis)
% ... challanges
% ... beware of the bigger picture, the goal, the mission ... the moon
% This thesis is our first steps? on the journey towards an efficient learning
% of programming.
% we will not be surprised if on the way to this glorious moon we will
% land up in totally different gallaxy.
