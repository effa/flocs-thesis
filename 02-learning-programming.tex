...
in several significant aspects (\cref{tbl:existing-systems-categorization}).
...
The rest of this section describes the most notable existing systems.
...
(figure \ref{fig:lightbot-robotanist} left).
%(figure \ref{fig:lightbot-instruction}).
Students create short programs to control a robot living in a grid world.
...
including difficult problems with sophisticated recursion.  After
